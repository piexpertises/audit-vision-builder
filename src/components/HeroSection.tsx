        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="animate-fade-up pt-20 md:pt-0">
            ...
            marginTop: 'clamp(80px, 12vh, 120px)'
              ...
              <span className="block mb-2" style={{ color: 'hsl(34 100% 55%)' }}>{t('hero.title')}</span>
            </h1>
          ...
          animationDelay: '0.6s'
            ...
            animationDelay: `${0.7 + index * 0.1}s`
              ...
              backgroundColor: 'hsl(34 100% 55% / 0.2)'
            }}>
                  <stat.icon className="h-10 w-10 md:h-8 md:w-8" style={{ color: 'hsl(34 100% 55%)' }} />
                </div>
                <div className="text-4xl md:text-3xl font-bold mb-3 md:mb-2" style={{ color: 'hsl(34 100% 55%)' }}>{stat.value}</div>
